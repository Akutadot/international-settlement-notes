...
> [!IMPORTANT]
> 本部分用于复习**汇票填制题**。  
> 建议复习顺序：**先看题目 → 自己尝试填写 → 再对照答案图片检查 → 最后回到表格总结易错点。**
...
## 🧠 9.1 汇票填写前先理解：汇票到底是什么？

汇票是一种**出票人要求付款人向收款人付款的书面支付命令**。
...
```mermaid
flowchart LR
  A[出票人 Drawer<br>开出汇票的人] -->|签发汇票<br>命令付款| B[付款人 Drawee<br>被要求付款的人]
  B -->|付款或承兑后付款| C[收款人 Payee<br>取得票款的人]
```
...
| 角色 | 英文 | 通俗理解 | 常见身份 |
|---|---|---|---|
| 出票人 | Drawer | 谁开出汇票 | 出口商 / 卖方 |
| 付款人 | Drawee | 谁被要求付款 | 进口商、开证行或指定银行 |
| 收款人 | Payee | 谁收钱 | 出口商、银行或指定收款人 |

> [!TIP]
> 做题时不要一上来就填空，先在题干里圈出：  
> **谁是卖方、谁是买方、谁开证、谁付款、谁收款、金额多少、付款期限是什么。**
...
| 汇票栏目 | 含义 | 填写提醒 |
|---|---|---|
| Date | 出票日期 | 通常根据题目给出的开票日期、发票日期或装运后日期填写 |
| Exchange for | 汇票金额 | 注意数字金额与大写金额一致 |
| At sight | 即期付款 | 见票即付 |
| At ... days after sight | 见票后若干天付款 | 属于远期汇票 |
| Pay to the order of | 收款人 | 常填银行或出口商 |
| The sum of | 大写金额 | 金额大写，币种不能漏 |
| Drawn under | 根据信用证开立 | 信用证项下汇票要写信用证号、开证行和开证日期 |
| To | 付款人 | 信用证项下常为开证行或指定银行 |
| For and on behalf of | 出票人签章 | 通常是出口商公司名称及签字 |
...
<p align="center">
  <img src="images/汇票题目1.png" width="780">
</p>

<p align="center">图 9-1 汇票填制题目 1</p>
...
<p align="center">
  <img src="images/汇票答案1.png" width="780">
</p>

<p align="center">图 9-2 汇票填制题目 1 参考答案</p>
...
> 🧩 **题目使用方法：**  
> 第二题继续按照“先判断当事人，再判断金额和期限，最后补充信用证或合同信息”的顺序完成。

<p align="center">
  <img src="images/汇票题目2.png" width="780">
</p>

<p align="center">图 9-3 汇票填制题目 2</p>
...
<p align="center">
  <img src="images/汇票答案2.png" width="780">
</p>

<p align="center">图 9-4 汇票填制题目 2 参考答案</p>
...
| 项目 | 英文 | 常见填写内容 | 易错点 |
|---|---|---|---|
| 出票人 | Drawer | 出口商 / 卖方 | 不要写成进口商 |
| 付款人 | Drawee | 进口商、开证行或指定银行 | 信用证项下常不是买方本人 |
| 收款人 | Payee | 出口商或指定银行 | `Pay to the order of...` 后面通常就是收款人 |
| 出票日期 | Date of Issue | 题目给出的日期 | 注意英文日期格式 |
| 汇票金额 | Amount | 发票金额或信用证允许金额 | 大小写金额必须一致 |
| 付款期限 | Tenor | `at sight`、`30 days after sight` 等 | 即期和远期不要混 |
| 信用证编号 | L/C No. | 根据信用证资料填写 | 信用证项下汇票一般要注明 |
| 开证行 | Issuing Bank | 信用证开证银行 | 常与付款人有关 |
| 出票人签章 | Signature | 出口公司名称及签字 | 最后签章不能漏 |
...
| 英文表达 | 含义 |
|---|---|
| `Drawn under L/C No....` | 根据信用证编号……开立 |
| `issued by ... Bank` | 由某银行开证 |
| `dated ...` | 开证日期或出票日期 |
| `at sight` | 即期付款 |
| `at 30 days after sight` | 见票后 30 天付款 |
| `for 100% invoice value` | 按发票金额 100% 开立汇票 |

> [!WARNING]
> 信用证项下汇票中，付款人不一定是进口商。  
> 很多情况下，汇票付款人可能是**开证行**或信用证指定的付款行。

---

## 👥 9.10 出票人、付款人、收款人和承兑人怎么区分？

```mermaid
flowchart TB
  A[汇票 Bill of Exchange] --> B[出票人 Drawer]
  A --> C[付款人 Drawee]
  A --> D[收款人 Payee]
  C --> E{是否承兑?}
  E -->|是| F[承兑人 Acceptor<br>到期承担付款责任]
  E -->|否| G[仍只是付款人 Drawee]
```
...
| 付款人 | ✅ 是 | 汇票是命令付款人付款 |
| 收款人 | ✅ 是 | 必须说明向谁付款 |
| 承兑人 | ❌ 不一定 | 只有远期汇票经承兑后，付款人才成为承兑人 |

> [!TIP]
> **付款人 ≠ 承兑人**。  
> 付款人只有在远期汇票上进行承兑后，才成为承兑人。
...
| 类型 | 英文表达 | 含义 | 是否需要承兑 |
|---|---|---|---|
| 即期汇票 | `at sight` | 见票即付 | 一般不需要承兑 |
| 远期汇票 | `at 30 days after sight` | 见票后 30 天付款 | 通常需要承兑 |
| 远期汇票 | `at 60 days after date` | 出票日后 60 天付款 | 通常需要承兑 |
| 远期汇票 | `at 90 days after B/L date` | 提单日后 90 天付款 | 通常需要承兑 |
...
| 易错点 | 正确理解 |
|---|---|
| 把出票人写成付款人 | 出票人一般是卖方，付款人是被要求付款的人 |
| 把付款人写成收款人 | 付款人是付钱的人，收款人是拿钱的人 |
| 忘记信用证编号 | 信用证项下汇票通常要注明 L/C No. |
| 即期和远期混淆 | `at sight` 是即期，`after sight` 是远期 |
| 金额大小写不一致 | 汇票金额必须严谨一致 |
| 忘记出票人签章 | 汇票最后需要出票人签署 |
